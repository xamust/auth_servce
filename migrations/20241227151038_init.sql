...
CREATE TABLE IF NOT EXISTS users (
                       ...
                       system_role_uuid varchar(36) NOT NULL,
...
VALUES
    ...
    ('manager@example.com', '$2a$10$FuHpGfpjv2BjKFhDiut45uimN7o5qqDSvOu1uKVTGZhJuidjqE.26', 'e3d62285-fbaa-46f4-8077-83dfb5b17227', true, '5fad25aa-0e2c-4ceb-8e08-0d4e4f9e4d01', null),
...
VALUES
    ('c901adc3-f360-4db8-992d-bf630c2386fa','admin', '5fad25aa-0e2c-4ceb-8e08-0d4e4f9e4d02', '{"role_title":"Администратор системы"}'),
    ('e3d62285-fbaa-46f4-8077-83dfb5b17227','manager', '5fad25aa-0e2c-4ceb-8e08-0d4e4f9e4d01', '{"role_title":"Менеджер организации"}'),
